...
/**
 * TechDivision\Import\Attribute\Actions\Processors\CategoryCreateProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The attribute create processor implementation.
 *
 * @author    Tim Wagner <t.wagner@techdivision.com>
 * @copyright 2016 TechDivision GmbH <info@techdivision.com>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
...
class AttributeCreateProcessor extends AbstractCreateProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            $utilityClassName::CREATE_CATEGORY => $utilityClassName::CREATE_CATEGORY
        );
    }
